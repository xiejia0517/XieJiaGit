...
<div class="row">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="text-center" width="20%">栏目名称</th>
                                    <th class="text-center" width="20%">栏目类型</th>
                                    <th class="text-center" width="20%">上级栏目</th>
                                    <th class="text-center" width="">测试</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="center"><?php echo $cateres['id']; ?></td>
                                    <td align="center"><input type="text" name="<?php echo $cateres['id']; ?>" style="width: 50px;" value="<?php echo $cateres['sort']; ?>"></td>
                                    <td><?php echo str_repeat('-',$cateres['level']*8)?><?php echo $cateres['catename']; ?></td>
                                    <td align="center"><?php if($cateres['type'] == 1): ?>列表<?php else: ?>单页<?php endif; ?></td>
                                    <td align="center"><?php echo $cateres['pid']; ?></td>
                                    <td align="center"><a onclick="changestatus(this)" href="#" class="btn btn-primary btn-sm shiny changestatus">测试</a></td>
                                    <td align="center">
                                        <a href="<?php echo url('cate/edit',array('id'=>$cateres['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗','<?php echo url('cate/del',array('id'=>$cateres['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                                ...
                                <tr>
                                    <td></td>
                                    <td align="center"><button  class="btn btn-primary btn-sm shiny" value="排序"  type="submit" style="width: 50px;">排序</button></td>
                                </tr>                      
                            </tbody>
                        </table>
                    </form>
    ...
    <script src="../../../../public/static/admin/js/test.js"></script>
