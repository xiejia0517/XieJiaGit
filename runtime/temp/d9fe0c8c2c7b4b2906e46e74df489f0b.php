                ...
                <div class="flip-scroll">
                    <form action="" method="POST">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($linkres) || $linkres instanceof \think\Collection || $linkres instanceof \think\Paginator): $i = 0; $__LIST__ = $linkres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$linkres): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $linkres['id']; ?></td>
                                    <td align="center"><?php echo $linkres['title']; ?></td>
                                    <td align="center"><?php echo $linkres['desc']; ?></td>
                                    <td align="center"><a href="<?php echo $linkres['url']; ?>" target="_blank"><?php echo $linkres['url']; ?></a></td>
                                    <td align="center">
                                        <a href="<?php echo url('link/edit',array('id'=>$linkres['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗','<?php echo url('link/del',array('id'=>$linkres['id'])); ?>')" class="btn btn-danger btn-sm shiny">
