                ...
                <div class="flip-scroll">
                    <form action="" method="POST">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articleres): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $articleres['id']; ?></td>
                                    <td align="center"><?php echo $articleres['title']; ?></td>
                                    <td align="center"><?php echo $articleres['author']; ?></td>
                                    <td align="center"><?php echo $articleres['keywords']; ?></td>
                                    <td align="center"><?php echo $articleres['desc']; ?></td>
                                    <td align="center"><img style="width:100px;height:auto;" src="<?php echo $articleres['thumb']; ?>" alt=""></td>
                                    <td align="center"><?php echo $articleres['catename']; ?></td>
                                    <td align="center"><?php echo $articleres['content']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('article/edit',array('id'=>$articleres['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗','<?php echo url('article/del',array('id'=>$articleres['id'])); ?>')" class="btn btn-danger btn-sm shiny">
