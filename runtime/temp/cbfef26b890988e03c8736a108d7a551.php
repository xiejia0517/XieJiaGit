                        ...
                        <table class="table table-bordered table-hover">
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="text-center" >配置项列表</th>
                                    <th class="text-center" width="10%">操作</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(is_array($confres) || $confres instanceof \think\Collection || $confres instanceof \think\Paginator): $i = 0; $__LIST__ = $confres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$confres): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $confres['id']; ?></td>
                                    <td align="center"><?php echo $confres['cnname']; ?></td>
                                    <td align="center"><?php echo $confres['enname']; ?></td>
                                    <td align="center"><?php echo $confres['type']; ?></td>
                                    <td align="center"><?php echo $confres['value']; ?></td>
                                    <td align="center"><?php echo $confres['values']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('config/edit',array('id'=>$confres['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗','<?php echo url('config/del',array('id'=>$confres['id'])); ?>')" class="btn btn-danger btn-sm shiny">
